...
function App() {
	...
	// 000111111110001000101000000111110000010001100000000000100001110000000010001011001000000100001101010000010001000010
	// 00011111111000100010100000011111000001000110000000000010000111000000001000101100100000010000110101000001000100000000000000000010
	// 00000100000101110000010001000000000001000011100000000100001100100000010000110101000001000100000000000000000010
	// 000100010100000011111000001000110000000000010000111000000001000101100100000010000110101000001000100001000011111111
	// 00010001010000001111100000100011000000000001000011100000000100010110010000001000011010100000100010000100001111110000000000000011
	...
	const decryptionStr = binaryStr => {
		...
		if (errorPosition > 0) {
			...
			binaryArray[errorPosition - 1] =
				binaryArray[errorPosition - 1] === '0' ? '1' : '0'
		}

		let originalValue = binaryArray.filter(
			(bit, i) => !controlBitsPositions.includes(i)
		)
	...
	const handleButtonClick = decryption => {
		...
		setDrawerContent([
			`${binaryValue}`,
			`Промежуточное значение: ${intermediateValue}`,
